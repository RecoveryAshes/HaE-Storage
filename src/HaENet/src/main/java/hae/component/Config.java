...
public class Config extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel ruleLabel = new JLabel("Rules Path:");
        JTextField pathTextField = new JTextField();
        pathTextField.setEditable(false);
        pathTextField.setText(configLoader.getRulesFilePath());
        JLabel databaseLabel = new JLabel("DB Path:");
        JTextField databasePathTextField = new JTextField();
        databasePathTextField.setEditable(false);
        databasePathTextField.setText(messageTableModel.getStoragePath());
        JButton reloadButton = new JButton("Reload");
        JButton reinitButton = new JButton("Reinit");
        constraints.gridx = 0;
        constraints.gridy = 0;
        constraints.weightx = 0.0;
        ruleInfoPanel.add(ruleLabel, constraints);
        constraints.gridx = 1;
        constraints.weightx = 1.0;
        ruleInfoPanel.add(pathTextField, constraints);
        constraints.gridx = 2;
        constraints.weightx = 0.0;
        ruleInfoPanel.add(Box.createHorizontalStrut(5), constraints);
        constraints.gridx = 3;
        ruleInfoPanel.add(reinitButton, constraints);
        constraints.gridx = 4;
        ruleInfoPanel.add(Box.createHorizontalStrut(5), constraints);
        constraints.gridx = 5;
        ruleInfoPanel.add(reloadButton, constraints);
        constraints.gridx = 0;
        constraints.gridy = 1;
        ruleInfoPanel.add(databaseLabel, constraints);
        constraints.gridx = 1;
        constraints.gridwidth = 5;
        constraints.weightx = 1.0;
        ruleInfoPanel.add(databasePathTextField, constraints);
